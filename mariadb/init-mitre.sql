-- init-mitre.sql
-- mitre_attack DB の初期化スクリプト
-- DB とユーザーの作成 → テーブル作成 の順で実行する。

CREATE DATABASE IF NOT EXISTS mitre_attack CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- mitre 用ユーザー作成(パスワードは Secret に合わせて変更すること)
-- 例: CREATE USER 'mitre'@'%' IDENTIFIED BY '<password>';
